...
import { destinasiData, kulinerData, Destinasi } from "@/lib/data";

// Konversi kulinerData ke format Destinasi agar bisa ditampilkan di card yang sama
const kulinerAsDestinasi: Destinasi[] = kulinerData.map((k) => ({
  id: `kuliner-${k.id}`,
  slug: `kuliner-${k.id}`,
  nama: k.nama,
  lokasi: k.lokasi,
...
// Gabungan semua data
const semuaData: Destinasi[] = [...destinasiData, ...kulinerAsDestinasi];
