      ...
      <div className="pt-28 pb-10 px-6 bg-gradient-to-b from-navy-800 to-navy-900">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-[#f0ede4]/50 text-sm max-w-xl">
            Panduan perjalanan, cerita petualangan, dan tips wisata terbaik
            untuk menjelajahi Lampung.
          </p>
        </div>
      </div>
          ...
          <div className="bg-navy-800 border border-white/8 hover:border-gold-500/30 rounded-3xl overflow-hidden transition-all duration-300 hover:-translate-y-1 mb-8 group cursor-pointer">
            ...
            <div className="p-7">
              <div className="flex items-center gap-3 mb-4">
                <span
                  className={`text-[10px] uppercase tracking-widest border rounded-full px-3 py-1 ${kategoriWarna[artikelList[0].kategori]}`}
                >
              ...
              >
                ...
                <div className="p-5">
                  <div className="flex items-center gap-2 mb-3">
                    <span
                      className={`text-[10px] uppercase tracking-widest border rounded-full px-2.5 py-0.5 ${kategoriWarna[artikel.kategori]}`}
                    >
                      {artikel.kategori}
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-gold-500/10 to-navy-800 border border-gold-500/20 rounded-3xl p-8 text-center">
            ...
            <p className="text-[#f0ede4]/50 text-sm mb-6 max-w-sm mx-auto">
              Dapatkan tips wisata, rekomendasi destinasi, dan cerita
              petualangan langsung di inbox kamu.
            </p>
