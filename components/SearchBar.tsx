...
export default function SearchBar() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="hidden sm:flex items-center gap-1 text-[#f0ede4]/25 text-xs border-r border-white/10 pr-3">
        <MapPin size={12} />
        <span>Lampung</span>
      </div>
      <button
        type="submit"
        className="bg-gold-500 hover:bg-gold-400 text-navy-900 text-xs font-medium px-4 py-2 rounded-lg transition-colors duration-200 flex-shrink-0 flex items-center gap-1.5"
      >
        <Search size={13} />
        Cari
      </button>
